...
# Load ONNX model
model_path = "test/eran_models/mnist_relu_3_100.onnx"
...
dummy_input = torch.randn(1, 1, 28, 28)  # e.g., MNIST
...
# input_shapes = get_value_info_shapes(model.graph.input)
# output_shapes = get_value_info_shapes(model.graph.output)
